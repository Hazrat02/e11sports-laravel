        ...
        <div class="border-bottom container pb-5">
            <div class="row">
                <div class="col-xl-12 text-center">
                    <h3><?php echo e(__(@$payment->data_values->heading)); ?></h3>
                </div>
                    ...
                    <div class="payment-slider">
                        ...
                        <div class="single-slide">
                            <div class="payment-item">
                                <img src="<?php echo e(getImage('assets/images/frontend/payment_method/' . @$payment->data_values->image, '85x65')); ?>" alt="image">
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 text-md-left">
                    <div class="footer-widget text-md-start text-center">
                        <a class="footer-logo" href="<?php echo e(route('home')); ?>">
                            <img src="<?php echo e(getImage(getFilePath('logoIcon') . '/logo.png')); ?>" alt="image">
                        </a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-8">
                    <form class="d-flex justify-content-end w-100 gap-2">
                        <div class="form-group w-100 mb-0">
                            <input class="form-control" name="email" type="text" placeholder="<?php echo app('translator')->get('Enter email address'); ?>">
                        </div>
                        <button class="cmn-btn btn-sm subscribe-btn type= flex-shrink-0" type="button"><?php echo app('translator')->get('Subscribe'); ?></button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="d-flex justify-content-sm-between justify-content-center align-items-center flex-wrap gap-3">
                <p><?php echo app('translator')->get('Copyright'); ?> &copy; <?php echo date('Y') ?>. <?php echo app('translator')->get('All Rights Reserved'); ?></p>
                <ul class="footer-social-links d-flex align-items-center justify-content-md-end justify-content-center flex-wrap">
                    ...
                    <li>
                        <a href="<?php echo e(@$social->data_values->url); ?>"><?php echo $social->data_values->social_icon ?></a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u400193054/domains/e11sports.com/public_html/core/resources/views/templates/basic/partials/footer.blade.php ENDPATH**/ ?>