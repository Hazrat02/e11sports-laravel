<div class="sidebar bg--dark">
    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a class="sidebar__main-logo"  href="{{ route('admin.dashboard') }}"><img  style="height:80px" src="{{ getImage(getFilePath('logoIcon') . '/logo3.png') }}" alt="@lang('image')"></a>
        </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.game*', 2) }}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.game.cricket') }}">
                                <a class="nav-link" href="{{ route('admin.game.cricket', ['status' => '2']) }}">
